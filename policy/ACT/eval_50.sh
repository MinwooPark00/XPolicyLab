...
#
#   bash eval_50.sh mhbench cocarry mhbench-cocarry-unitree_g1x2_centralized-joint-0 unitree_g1x2_centralized joint 0 0 0 mhbench_act

#   bash eval_50.sh mhbench handover mhbench-handover-unitree_g1x2_centralized-joint-0 unitree_g1x2_centralized joint 0 0 0 mhbench_act 50 eval_results/handover/centralized
#   bash eval_50.sh mhbench handover handover unitree_g1x2_decentralized joint 0 0 0 mhbench_act 50 eval_results/handover/decentralized
#
...
# Resolve to absolute now: the per-episode subshell below cd's into
# MHBENCH_ROOT before invoking python, so a relative out_dir would have every
# --results_path/--video_dir land under MHBENCH_ROOT instead of here.
mkdir -p "${out_dir}"
